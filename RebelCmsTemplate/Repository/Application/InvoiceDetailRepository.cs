    ...
    public class InvoiceDetailRepository
    {
        ...
        public int Create(InvoiceDetailModel invoiceDetailModel)
        {
            ...
            try
            {
                ...
                sql += @"INSERT INTO invoice_detail (invoiceDetailId,invoiceId,productId,invoiceDetailUnitPrice,invoiceDetailQuantity,invoiceDetailDiscount,isDelete) VALUES (null,@invoiceId,@productId,@invoiceDetailUnitPrice,@invoiceDetailQuantity,@invoiceDetailDiscount,@isDelete);";
