...
public class FollowUpController : Controller
{
    ...
    public FollowUpController(RenderViewToStringUtil renderViewToStringUtil, IHttpContextAccessor httpContextAccessor)
    {
    ...
    public async Task<IActionResult> Get()
    {
        ...
        var content = followUpRepository.GetExcel();
        return File(
            content,
    ...
    public ActionResult Post()
    {
        ...
        var followUpName = Request.Form["followUpName"];
        var followUpKey = Convert.ToInt32(Request.Form["followUpKey"]);
        ...
        switch (mode)
        {
            case "create":
                ...
                else
                {
                    try
                    {
                        lastInsertKey = followUpRepository.Create(new FollowUpModel
                        {
            ...
            case "search":
                ...
                else
                {
                    try
                    {
                        data = followUpRepository.Search(search);
            ...
            case "update":
                ...
                else
                {
                    try
                    {
                        followUpRepository.Update(new FollowUpModel
                        {
                            FollowUpName = followUpName,
            ...
            case "delete":
                ...
                else
                {
                    try
                    {
                        followUpRepository.Delete(new FollowUpModel
                        {
                            FollowUpKey = followUpKey
                        });
