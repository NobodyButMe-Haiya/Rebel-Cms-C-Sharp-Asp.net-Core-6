    ...
    public class SharedUtil
    {
        ...
        public void SetQueryException(string? stringSql, MySqlException exceptionText)
        {
            ...
            try
            {
                ...
                const string sql = " INSERT INTO log  (logId,tenantId,userId,logUserName,logQuery,logError,LogDateTime) VALUES (null,@userId,@tenantId,@userName,@logQuery,@logError,NOW());";
        ...
        public static string GetSqlSessionValue(string sql, List<ParameterModel> parameterModels)
        {
            ...
            foreach (ParameterModel parameterModel in parameterModels)
            {
